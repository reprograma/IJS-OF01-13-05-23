...
describe('Calcular pacote de acordo com cada projeto', () => {
    ...
    test('Retorna pacote intermediário caso o número total de horas seja exatamento 100', () =>{
    ...
    test('Retorna pacote premium caso o número total de horas seja exatamento 200', () =>{
