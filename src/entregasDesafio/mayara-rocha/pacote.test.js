...
describe("Teste para o cálculo do pacote de acordo com cada projeto", () => {
  ...
  test("Retorna pacote básico com o número total de horas seja exatamente 50", () => {
  ...
  test("Retorna pacote intermediário com o número total de horas seja exatamente 100", () => {
