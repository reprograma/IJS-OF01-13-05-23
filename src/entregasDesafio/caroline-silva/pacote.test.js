...
describe('Testa a função pacote', () => {
  ...
  test('Se ao passar 50 retorna pacote_intermediario', () => {
    expect(calcularPacote(50)).toBe('pacote_intermediario');
  });
  ...
  test('Se ao passar 100 retorna pacote_premium', () => {
    expect(calcularPacote(100)).toBe('pacote_premium');
  });
